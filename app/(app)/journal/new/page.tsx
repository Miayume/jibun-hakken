...
import ScrollToTopOnSaved from "@/app/(app)/journal/new/ScrollToTopOnSaved";
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-8">
      {saved && (
        <>
          <ScrollToTopOnSaved />
          <p className="mb-4 rounded bg-green-50 border border-green-200 text-green-800 px-3 py-2 text-sm font-medium">
            ✓ 記録を保存しました。
          </p>
        </>
      )}
